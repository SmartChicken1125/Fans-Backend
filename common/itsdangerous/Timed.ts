...
import Json, { SerializerLike } from "./internal/Json.js";
import Time from "./internal/Time.js";

import { BaseSerializer } from "./Serializer.js";
import { BaseSigner, Signer, SignerOptions } from "./Signer.js";

import { SigningAlgorithm } from "./Algorithms.js";
import { URLSafeBase64DecodeInt, URLSafeBase64EncodeInt } from "./Encoding.js";
import { BadTimeSignature, SignatureExpired } from "./Error.js";
import { required, rsplit } from "./Utils.js";
...
export class BaseTimestampSigner extends BaseSigner {
	...
	unsign(signedValue: string, maxAge: number, returnTimestamp = false) {
		...
		const [value, timestampVal] = rsplit(result, this.sep);
