import { BaseSerializer, SerializerOptions } from "./Serializer.js";
import { BaseTimedSerializer, TimestampSignerOptions } from "./Timed.js";

import { URLSafeBase64Decode, URLSafeBase64Encode } from "./Encoding.js";

import { SerializerLike } from "./internal/Json.js";
 ...
 */
export const URLSafeSerializer = function (
	secretKey: string,
 ...
 * @param {function} [options.signerArgs.algorithm]
 */
export const URLSafeTimedSerializer = function (
	secretKey: string,
	options: TimestampSignerOptions = {},
) {
